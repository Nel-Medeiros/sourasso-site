...
export default function BottomNav() {
  ...
  return (
    <nav aria-label="Navegação principal" className="fixed bottom-0 left-0 right-0 bg-white border-t border-cream h-16 z-50 shadow-[0_-2px_8px_rgba(0,0,0,0.06)]">
      <div className="max-w-7xl mx-auto flex justify-around items-center h-full">
